...
namespace P02_WebApr2023_Assg1_Team6.DAL
{
    public class ShippingRateDAL
    {
        ...
        { //Create a SqlCommand object from connection object
            ...
            while (reader.Read())
            {
                shippingRateList.Add(new ShippingRate
                {
                    ...
                    ShippingRates = reader.GetDecimal(5), //6: 5th column
        ...
        public int Add(ShippingRate shippingRate)
        {
            ...
            cmd.Parameters.AddWithValue("@shippingRate", shippingRate.ShippingRates);
        ...
        public int Update(ShippingRate shippingRate)
        {
            ...
            //Define the parameters used in SQL statement, value for each parameter
            //is retrieved from respective class's property.
            cmd.Parameters.AddWithValue("@sRate", shippingRate.ShippingRates);
        ...
        public ShippingRate GetShippingRatebyCC(string toCity, string toCountry)
        {
            SqlCommand cmd = conn.CreateCommand(); //Specify the SELECT SQL statement
            cmd.CommandText = @"SELECT * FROM ShippingRate 
            WHERE ToCity = @tocity AND ToCountry = @tocountry"; //Open a database connection
            //adding parameter with values used 
